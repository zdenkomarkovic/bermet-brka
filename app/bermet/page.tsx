...
export default function BermetPage() {
  ...
  const bermetProducts = products.filter(
    (product) => product.category === "Bermet"
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="mb-12 bg-muted/30">
          <CardHeader>
            ...
            <CardDescription>
              Vekovima stara tradicija Sremskih Karlovaca
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Bermet je tradicionalno desertno aromatično vino koje se vekovima
              proizvodi u Sremskim Karlovcima. Sličan je italijanskom vermutu,
              ali se proizvodi drugačije - kroz mačeraciju lekovitih biljaka i
              začina.
            </p>
            <p className="text-muted-foreground">
              ...
              Karlovcima – bermetom! Karlovački bermet je služen na kraljevskim
              dvorovima, brodovima, pa čak i na čuvenom oceanu liner Titaniku.
            </p>
            <p className="text-muted-foreground">
              Bermet je bio na početku korišćen kao lek. I danas se smatra
              lekovitim za dušu i unutrašnje organe, te afrodizijak za žene.
            </p>
