...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary/10 via-background to-primary/5 py-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card>
                <CardHeader className="pb-3">
                  ...
                  <CardTitle className="text-xl">Kraljevski opskrbljivač</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h2 className="text-4xl font-bold text-foreground">Šta je Bermet?</h2>
            </div>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Tradicionalno desertno aromatično vino koje se vekovima proizvodi u ovom kraju
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="text-muted-foreground">
                  Sremski Karlovci vekovima su poznati po kvalitetnim vinima i čuvenom bermetu.
                  Karlovački bermet je služen na kraljevskim dvorovima, brodovima, pa čak i na čuvenom oceanu liner Titaniku.
                </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="text-muted-foreground">
                  Bermet je posebno likerno vino, povezano sa vermutom, ali proizvedeno na drugačiji način - aromatizovano slatkim vinom i obogaćeno sa više od 20 mirisnih gorkih trava i začina.
                </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h2 className="text-4xl font-bold text-foreground">Lekovito bilje i tinkture</h2>
            </div>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Pored bermeta, nudimo i širok asortiman lekovitih tinktura i preparata od prirodnog bilja
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground">
                <p>
                  Kao što bermet kombinuje vino sa lekovitim biljem, tako smo i proširili našu ponudu sa različitim tinkturama i kapima koje pomažu kod različitih zdravstvenih problema.
                </p>
                <p>
                  Svaka tinktura se priprema po tradicionalnom receptu, sa pažljivo odabranim biljem koje se namače u alkoholu minimum 20 dana kako bi se izvukle sve lekovite materije.
                </p>
                <p className="font-semibold text-foreground">
                  U našoj ponudi: tinkture crnog oraha, čagi gljive, koprive, sikavice, gloga, cimeta, đumbira i mnogih drugih lekovitih biljaka.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong className="text-foreground">Bermet</strong> - Beli i crveni, tradicionalno desertno vino</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Leaf className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Tinkture</strong> - Od crnog oraha, čagi, koprive, sikavice, gloga i drugih biljaka</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Leaf className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Kapi</strong> - Zeleni orah, za zdrave vene, i druge specijalizovane mešavine</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Heart className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Specijalne formule</strong> - Za cirkulaciju, holesterol, menopauzu i drugo</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">Posetite nas</h2>
            <p className="text-xl text-muted-foreground">
              Vinarija Aleks - Bermet Brka
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                <CardTitle>Novi Sad</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground">
                <p className="font-semibold mb-2">Paje Markovića Adamova 26</p>
                <p>Novi Sad, Srbija</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Sremski Karlovci</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground">
                <p className="font-semibold mb-2">Petrovaradinska 5</p>
                <p>Sremski Karlovci, Srbija</p>
              </CardContent>
            </Card>
          </div>
